...
import data2023 from "../Jsondata/SSC_CGL_2023_Questions.json";
import { arrayUnion, doc, updateDoc } from "firebase/firestore";
import { db } from "../config/firebase";
import { getAuth } from "firebase/auth";

function Ssc_cgl_2023() {
  ...
  const totalQuestions = data2023.questions.length;
      ...
      <div className=" rounded-lg  p-6 w-full max-w-4xl">
        {!showResult ? (
          <>
            ...
            {data2023.questions.map((question, questionIndex) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="font-medium text-gray-800">
                      Q{questionIndex + 1}: ({question.section}):{" "}<br/>
                      {question.question}
                    </p>
                    <p
                      className={`mt-2 ${
