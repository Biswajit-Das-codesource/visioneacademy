...
import data2022 from "../Jsondata/Railway_Group_D_2022_Questions.json";

// import { doc, updateDoc, arrayUnion } from "../config/firebase";
import { arrayUnion, doc, updateDoc } from "firebase/firestore";

import { db } from "../config/firebase"; // adjust the path to your firebase config
import { getAuth } from "firebase/auth";

function Railway_GD_2022() {
  const [selectedOptions, setSelectedOptions] = useState({});
  const [successCount, setSuccessCount] = useState(0);
  const [showResult, setShowResult] = useState(false);
  const [showDialog, setShowDialog] = useState(false);

  const questions = data2022.questions;
                ...
                return (
                  ...
                  >
                    ...
                    <p className="font-medium text-gray-800">
                      Q{questionIndex + 1} ({question.section}):{" "}
...
export default Railway_GD_2022;
