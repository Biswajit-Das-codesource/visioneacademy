...
import data2022 from "../Jsondata/SBI_Clerk_2022_50_Questions.json";
import { arrayUnion, doc, updateDoc } from "firebase/firestore";
import { db } from "../config/firebase";
import { getAuth } from "firebase/auth";

function Sbi_cleark2022() {
  ...
  const totalQuestions = data2022.questions.length;
  const answeredCount = Object.keys(selectedOptions).length;
  const skippedCount = totalQuestions - answeredCount;

  const optionLabels = ["A", "B", "C", "D", "E"];

  console.log(data2022.questions.length);
      ...
      <div className="rounded-lg  p-6 w-full max-w-4xl">
        {!showResult ? (
          <>
            ...
            {data2022.questions.map((question, questionIndex) => {
