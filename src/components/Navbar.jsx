    ...
    <nav className="relative z-50 bg-gradient-to-r from-[#f7f7f7] to-[#f5f7ff] shadow">
      <div className="flex justify-between items-center px-4 py-4 md:px-6">
                  ...
                  {Object.keys(examData).map((item) => (
                    <div
                      ...
                      className={`px-4 py-3 mb-2 ${
                        selectedCategory === item ? "bg-pink-100" : "bg-pink-50"
                ...
                <div className="flex-1 grid grid-cols-3 gap-4 p-4 overflow-y-auto max-h-[400px]">
                  {examData[selectedCategory]?.map((exam, index) => (
                    ...
                    >
                      ...
                      <span>{typeof exam === "string" ? exam : exam.name}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="hidden md:block border border-blue-500 text-blue-600 font-medium px-4 py-1.5 rounded hover:bg-blue-50">
            Login
          </button>
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white px-4 pb-6">
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button className="border border-blue-500 text-blue-600 font-medium px-4 py-1.5 rounded hover:bg-blue-50">
              Login
            </button>
